...
import { Code2Icon, Github, Menu, Sparkles, Twitter, Youtube } from "lucide-react";
...
const components: { title: string; href: string; description: string }[] = [
  {
    title: "Discussions",
    href: "/discussion",
    description: "Interact with the other people .",
  }
];
    ...
    >
      <div className="flex items-center justify-between p-4 max-w-7xl mx-auto">
        ...
        <div className="hidden lg:flex items-center gap-2">
          <Link href="/" prefetch={true} className="flex items-center gap-2">
            <Code2Icon className="h-5 w-5 text-blue-600" />
        ...
        <div className="hidden lg:flex items-center gap-6">
          ...
          <Link href="/discussions" prefetch={true}>
            <Button variant="ghost">Discussions</Button>
          </Link>
          {/* In Case I want to go open source with this project */}
          {/* <Link
